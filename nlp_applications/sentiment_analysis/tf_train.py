...
common_path = str(Path(currentdir).parent)
...
if __name__ == '__main__':
    ...
    predict(token_vocab, target_vocab, '단지 한가지..역에서 가까운 메리트는 있지만 전철소리가 시끄러워!')
    predict(token_vocab, target_vocab, '하지만 밤에는 조금 시끄러웠다.')
